...
class CmdBetrachte(COMMAND_DEFAULT_CLASS):
    """
    Dinge oder Orte ansehen.
    ...
    Betrachte Orte oder Objekte in deiner Nähe.
    """
...
class CmdAlias(COMMAND_DEFAULT_CLASS):
    """
...
class CmdInventar(COMMAND_DEFAULT_CLASS):
    """
    Inventar ansehen
...
class CmdNimm(COMMAND_DEFAULT_CLASS):
    """
    etwas aufnehmen
    ...
    Nimmt einen Gegenstand auf und bewegt ihn in dein Inventar.
    """
...
class CmdLege(COMMAND_DEFAULT_CLASS):
    """
    lege etwas ab
    ...
    Lässt dich etwas aus deinem Inventar dort ablegen,
    wo du dich grade aufhältst.
    """
...
class CmdGib(COMMAND_DEFAULT_CLASS):
    """
    gibt etwas an jemanden

    Usage:
      gib <inventory obj> <to||=> <target>

    Gibt ein Objekt aus deinem Inventar an eine andere Person,
    der Gegenstand befindet sich anschließend in deren Inventar.
    """
...
class CmdSag(COMMAND_DEFAULT_CLASS):
    """
...
class CmdFlüster(COMMAND_DEFAULT_CLASS):
    """
...
class CmdIch(COMMAND_DEFAULT_CLASS):
    """
    strike a pose
